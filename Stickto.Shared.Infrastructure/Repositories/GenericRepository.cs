...
{
    /// <summary>
    /// Provides a repository for managing entities of type <typeparamref name="TEntity"/> with identifiers of type <typeparamref name="TId"/>.
    /// </summary>
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    /// <typeparam name="TId">The type of the entity's identifier.</typeparam>
    public class GenericRepository<TEntity, TId> : AbstractionRepository<TEntity>, IGenericRepository<TEntity, TId>
        where TEntity : Entity
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericRepository{TEntity, TId}"/> class with the specified context.
        /// </summary>
        ...
        /// collection is null.</exception>
        /// <returns>A task that represents the asynchronous operation.</returns>
        public async Task BulkInsert(IEnumerable<TEntity> entities, CancellationToken cancellationToken)
        {
            ArgumentNullException.ThrowIfNull(entities);
        ...
        /// </exception>
        public async Task BulkUpdate(IEnumerable<TEntity> entities, CancellationToken cancellationToken)
        {
            ArgumentNullException.ThrowIfNull(entities);
        ...
        /// Thrown when the <paramref name="entities"/> collection is null.
        /// </exception>
        public async Task BulkRemove(IEnumerable<TEntity> entities, CancellationToken cancellationToken)
        {
            ArgumentNullException.ThrowIfNull(entities);
